        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4 text-lg">
            ...
            <div className="text-center">
              <h6 className="mb-4 flex justify-center font-semibold uppercase text-xl">
                خدمات ما
              </h6>
              <p className="mb-4">
                <a href="#" className="text-neutral-100 dark:text-neutral-200">
            ...
            <div className="text-center">
              <h6 className="mb-4 flex flex-col font-semibold uppercase text-xl">
                لینک ها
              </h6>
            ...
            <div className="">
              <h6 className="mb-4 flex items-center justify-center font-semibold uppercase text-lg md:text-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <p
                dir="rtl"
                className=" text-xl text-neutral-200 text-justify dark:text-neutral-200"
              >
